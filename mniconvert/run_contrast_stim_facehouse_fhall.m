...
for ii=1:size(Ss,2),
    ...
    for jj=1:size(cons,1),
        ...
        % DATAPATH/contrast/XX_stim_facehouse/
        copyfile(fullfile(datadir,conname),...
                fullfile(datadir,newconname))
        movefile(fullfile(datadir,newconname),'stim_facehouse')
    end
