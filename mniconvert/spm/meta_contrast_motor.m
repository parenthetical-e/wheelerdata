function meta_contrast_motor(data_path,delete_old),
% meta_contrast_motor(data_path,delete_old)
% 
...
% <delete_old> - Keep (0) or delete (1) old contrasts 
    ...
    jobs{2}.stats{1}.con.consess{4}.tcon.name = 'R';
